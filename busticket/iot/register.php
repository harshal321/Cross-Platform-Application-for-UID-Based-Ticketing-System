...
<section id="wrapper" class="login-register" style="background-image:url(images/bus.gif) !important">
  ...
  <div class="login-box">
    <div class="white-box">
      ...
      <form class="form-horizontal form-material" id="loginform" action="register_back.php" method="POST">
        ...
        <div class="form-group">
          <div class="col-xs-12">
            <input class="form-control" type="tel"  pattern="[0-9]{10}" placeholder="Contact number" name="phone" required>
          </div>
        </div>
